...
Component({
  ...
  data: {
    ...
    nodeList: [],
    textBufferPool: [],
    addUrl: 'https://www.mingsonic.xyz/demo/weedit/addtext',
    addUrlContent: 'https://www.mingsonic.xyz/demo/weedit/addtextcontent',
    modifyUrl: 'https://www.mingsonic.xyz/demo/weedit/modifytext'
  },
    ...
    formSubmit: function(e) {
      ...
      wx.request({
        ...
        data: {
          ...
          "textAuthorId": app.globalData.userID
        },
        method: 'POST',
        header: {
